...
class Select_source(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.title_frame.setStyleSheet("background-color:#3D4358;\n"
        ...
        self.arrowBtn = QtWidgets.QToolButton()
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../src/assets/arrow_open.png"))
        self.arrowBtn.setIcon(icon)
        self.arrowBtn.setIconSize(QtCore.QSize(12, 11))
        self.arrowBtn.setStyleSheet("color:white;\n"
                                          "border:none;\n"
                                          "padding:0 0 0 0;")
        self.HLayout_title.addWidget(self.arrowBtn)
        ...
        self.HLayout_btns = QtWidgets.QHBoxLayout(self.buttons_frame)
